...
namespace NzbDrone.Core.Indexers.Definitions
{
    ...
    public class AnimeWorld : Unit3dBase
    {
        ...
        public AnimeWorld(IIndexerHttpClient httpClient, IEventAggregator eventAggregator, IIndexerStatusService indexerStatusService, IIndexerDefinitionUpdateService definitionService, IConfigService configService, Logger logger)
