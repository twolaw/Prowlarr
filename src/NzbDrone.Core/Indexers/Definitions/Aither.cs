...
namespace NzbDrone.Core.Indexers.Definitions
{
    ...
    public class Aither : Unit3dBase
    {
        ...
        public Aither(IIndexerHttpClient httpClient, IEventAggregator eventAggregator, IIndexerStatusService indexerStatusService, IIndexerDefinitionUpdateService definitionService, IConfigService configService, Logger logger)
